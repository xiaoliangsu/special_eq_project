            ...
            <Row><!--wang-->
              ...
              <Form-item label="投入使用日期" prop="eqUseDate">
                ...
                <Poptip trigger="focus">
                  ...
                  <DatePicker v-model="ruleForm.eqUseDate" style="width:118.11%" format="yyyy年MM月dd日"></DatePicker>
                </Poptip>
              </Form-item>
            ...
            <Row>
              ...
              <Form-item label="检验日期" prop="testDate">
                ...
                <Poptip trigger="focus">
                  ...
                  <DatePicker  format="yyyy年MM月dd日" v-model="ruleForm.testDate" style="width:118.11%"></DatePicker>
                </Poptip>
              </Form-item>
              </Col>
            </Row>
