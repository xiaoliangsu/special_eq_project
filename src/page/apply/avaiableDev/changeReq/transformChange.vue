<template>
  <!--按套申请的使用登记表-->
  <div class="transformChange">
    <div class="transformChange_topbar">
      <!--<div class="bread">-->
      ...
      <div class="step" style="width:85%; margin-top:20px;">
        <Steps :current="current">
          ...
          <Step title="步骤1" content="填写特种设备使用登记表和使用登记证变更证明"></Step>
          <Step title="步骤2" content="预览特种设备使用登记表和使用登记证变更证明"></Step>         
    ...
    <div class="transformChange_content" style="position:absolute;top:85px;">
      <Form ref="ruleForm" :model="ruleForm" :rules="rules" :label-width="110" label-position="left">
        <div class="statusInfo" v-if="this.active==1">
          ...
          <div class="base-box">
            ...
            <Row>
              ...
              <Form-item label="原使用登记证编号" prop="pastNo">
                <Input v-model="ruleForm.pastNo" ></Input>
              </Form-item>
              </Col>
            </Row>
            ...
            <Row>
              ...
              <Form-item label="产品编号" prop="productNo">
                <Input v-model="ruleForm.productNo" ></Input>
              </Form-item>
              </Col>
              <Col span="11" offset="2">
              <Form-item label="制造日期" prop="produceDate">
                <Input v-model="ruleForm.produceDate" ></Input>
              </Form-item>
              </Col>
            </Row>
            <Form-item label="原使用单位名称" prop="pastUseComName">
              <Input v-model="ruleForm.pastUseComName" ></Input>
            </Form-item>
            <Row>
              <Col span="11">
              <Form-item label="原使用登记证签发日期" prop="pastSignDate">
                <Input v-model="ruleForm.pastSignDate" ></Input>
              </Form-item>
              </Col>
              <Col span="11" offset="2">
              <Form-item label="变更类别" prop="changeKind">
                <Input v-model="ruleForm.changeKind" ></Input>
              </Form-item>
              </Col>
            </Row>
          </div>
          ...
          <div class="base-box">
            <p>该特种设备的使用登记证已在本登记机关办理注销手续。
            </p>
            <Row>
              <Col span="11">
              <Form-item label="(原)登记机关" prop="pastRegist">
                <Input v-model="ruleForm.pastRegist" ></Input>
              </Form-item>
              </Col>
              <Col span="11" offset="2">
              <Form-item label="加盖公章日期" prop="stampedDate">
                <DatePicker v-model="ruleForm.stampedDate"></DatePicker>
              </Form-item>
              </Col>
            </Row>
          </div>
        ...
        <div class="setTable" v-if="this.active==2" style="width:900px;top:30px;position:absolute">
          <iframe id="iFramePdf" v-bind:src=this.pdfUrl style="width:45%;height:1000px;margin-left:30px;">
          </iframe>
          <iframe id="iFramePdf" v-bind:src=this.pdfUrl style="width:45%;height:1000px;margin-left:50px;">
          </iframe>
          </br>
        ...
        <div class="pdfInfo" v-if="this.active==3">
          ...
          <Form-item label="重新填写的使用登记表" :label-width="300">
          ...
          <Form-item label="改造监督检验证书(需要监督检验的)" :label-width="300">
            <Upload action="//jsonplaceholder.typicode.com/posts/"
                    :on-success="handleSuccess"
                    with-credentials>
              <Button type="ghost" icon="ios-cloud-upload-outline">上传文件</Button>
        ...
        <div class="transformChange_button">
...
//        checkComList: [],
    ...
    '$route.query':function(){
      ...
      if(this.$route.path=='/transformChange'){
          this.initData();
      }
    }
    },
