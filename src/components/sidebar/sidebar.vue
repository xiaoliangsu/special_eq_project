<template>
  ...
  <div class=" manage_page fillcontain sidebar">
      ...
      <Row>
          <Col span="8">
          <Menu  theme="dark" class="sideMenu" style="width:180px;min-height:100%" :open-names="['1']" accordion @on-select="routeTo">
              <Submenu name="1">
                  <template slot="title">
                  ...
                  <Menu-item name="test">变更申请</Menu-item>
                  <Menu-item name="home">停用申请</Menu-item>
                  <Menu-item name="home">报废申请</Menu-item>
              </Submenu>
              <Submenu name="2">
                  <template slot="title">
