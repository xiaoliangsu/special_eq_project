  ...
  <div class="detailPdf">
    <ul class="detail_ul">
      <li v-for="(item,key,index) in pdfUrl" class="detail_li">
        <a v-bind:href="'/file/download?fileId='+item" download="key" class="detail_a">{{key.replace(/\d+/g,'')}}.pdf</a>
        ...
        <embed v-if="pdfToggle[index]==0" v-bind:src="'/file/preview?fileId='+item" width="100%" height="1000px"/>
      </li>
    </ul>
  </div>
</template>
